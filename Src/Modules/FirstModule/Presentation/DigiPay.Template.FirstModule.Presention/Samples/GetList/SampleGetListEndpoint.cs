...
using DigiPay.Template.FirstModule.Application.UseCases.Samples;
using DigiPay.Template.FirstModule.Application.UseCases.Samples.GetList;
using FastEndpoints;
using MediatR;

namespace DigiPay.Template.FirstModule.Presention.Samples.GetList;
