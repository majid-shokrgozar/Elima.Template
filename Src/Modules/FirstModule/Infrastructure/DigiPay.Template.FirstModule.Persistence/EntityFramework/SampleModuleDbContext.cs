...
namespace DigiPay.Template.FirstModule.Persistence.EntityFramework;
...
public class SampleModuleDbContext : EfCoreDbContext<SampleModuleDbContext>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(DigiPayFirstModulePersistenceModule).Assembly);
    }
}
